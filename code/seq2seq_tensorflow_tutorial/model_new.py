...
class Seq2SeqModel():
    ...
    def _init_decoder_train_connectors(self):
        ...
        with tf.name_scope('DecoderTrainFeeds'):
            ...
            self.decoder_train_inputs = tf.concat([EOS_SLICE, self.decoder_targets], 0)
            self.decoder_train_length = self.decoder_targets_length + 1

            decoder_train_targets = tf.concat([self.decoder_targets, PAD_SLICE], 0)
